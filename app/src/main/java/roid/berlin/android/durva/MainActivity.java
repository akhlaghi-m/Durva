        ...
        try {
            ...
            if(obj.optString("status").equals("true")){
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    modelRecycler.setImageUrl(dataobj.getString("thumbnail_image"));
                    modelRecycler.setPageTitle(dataobj.getString("page_title"));
                ...
                Toast.makeText(MainActivity.this, obj.optString("message")+"gdggdfjkdsk", Toast.LENGTH_SHORT).show();
            }
